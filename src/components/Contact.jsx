          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400">Uttar Pradesh, Ghaziabad</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400">amit962kr@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-400">+91 9508375312</p>
              </div>
            </div>
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/Amitkr221"
                  target="_blank"
                ...
                <a
                  href="http://www.linkedin.com/in/amit-kumar-3ba980257"
                  target="_blank"
                  className="w-12 h-12 rounded-full 
                    bg-dark-300 flex items-center justify-center
